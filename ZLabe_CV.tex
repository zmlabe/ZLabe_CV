...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, N.C. Johnson, and T.L Delworth (2023). Changes in United States summer temperatures revealed by explainable neural networks. (\textit{accepted}) \href{https://doi.org/10.22541/essoar.168987129.98069596/v1}{[Preprint]}
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Jan. 2024 & \textit{AMS AI Conference - Student Competition}, Poster Judge (\textit{Upcoming!})\\ 
...
Jan. 2024 & \textit{ACCAP - IARC, University of Alaska Fairbanks}, Arctic Report Card: Background and Key Finding. (\textbf{Panelist-Invited-Remote}) (\textit{Upcoming!})\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter ($>$65,400 followers)} \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
