...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L., \textbf{Z. Labe}, and C. Ladd, 2020. [The Arctic] Sea surface temperature [in ``State of the Climate in 2019'']. Bull. Amer. Meteor. Soc. (\textit{revised})
\end{etaremune}
