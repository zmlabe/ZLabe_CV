...
\item Eischeid, J.K., M.P. Hoerling, X.-W. Quan, A. Kumar, J. Barsugli, \textbf{Z.M. Labe}, K.E. Kunkel, C.J. Schreck III, D.R. Easterling, T. Zhang, J. Uehling, and X. Zhang (2023). Why has the summertime central U.S. warming hole not disappeared? (\textit{accepted})
...
Jun. 2023 & \textit{La Uni Clim\'{a}tica}, Monitoring indicators of climate change through data-driven visualization. (\textit{Upcoming-Invited-Presenter-Remote})\\
Jun. 2023 & \textit{EUMET/Copernicus Earth Observation - Data Visualization Workshop Series}, Climate Extremes: Heatwaves, Changes in Ice, Drought, Sea Ice Anomalies. (\textit{Upcoming-Invited-Presenter-Remote})\\
...
May 2023 & Expert Contributor to the NCAR Climate Data Guide: ``Pan-Arctic Ice Ocean Modeling and Assimilation System (PIOMAS)''\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$61,900 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
