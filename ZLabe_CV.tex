...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2022), Predicting slowdowns in decadal climate warming trends with explainable neural networks. Geophysical Research Letters, DOI:10.1029/2022GL098173. \href{https://doi.org/10.1029/2022GL098173}{[Article]}
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Witt, J.K., \textbf{Z.M. Labe}, and B.A. Clegg (2022). Comparisons of perceptions of risk for visualizations using animated risk trajectories versus cones of uncertainty. (\textit{accepted})
...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2022), Comparison of climate model large ensembles with observations in the Arctic using simple neural networks. (\textit{submitted}) \href{https://www.essoar.org/doi/abs/10.1002/essoar.10510977.2}{[Preprint]}
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Jul. 2022 & \textit{REU Professional Development Series}, Making effective scientific figures, Colorado State University, Fort Collins, CO. (\textbf{Presenter-Invited})\\
...
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
2018-Present & Journal Manuscript Referee \href{https://publons.com/author/1521902/zachary-labe#profile}{[Publons]} - \textit{Artificial Intelligence for the Earth Systems}, \textit{Atmosphere-Ocean}, \textit{Atmosphere}, \textit{Climatic Change}, \textit{Climate Dynamics}, \textit{Geophysical Research Letters}, \textit{Geosciences}, \textit{International Journal of Climate}, \textit{Journal of Climate}, \textit{Journal of Geophysical Research: Atmospheres}, \textit{Journal of Glaciology}, \textit{Nature Climate Change}, \textit{Nature Communications}, \textit{Polar Geography}, \textit{Remote Sensing}, \textit{Scientific Reports}, \textit{Weather and Climate Dynamics} \\
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Jun. 2022 & 2022 CESM Workshop, Mesa Lab, National Center for Atmospheric Research (NCAR), Boulder, CO. (Virtual)\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$46,500 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
