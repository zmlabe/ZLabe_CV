...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2026). [The Arctic] Sea surface temperature [in ``State of the Climate in 2025'']. (\textit{submitted})
\item Zhang, Y. and \textbf{Z.M. Labe} (2026). Adapting Infrastructure to a Changing Climate with Extreme Event Attribution Assessments. (\textit{accepted})
