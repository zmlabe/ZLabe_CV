...
One Palmer Square, Suite 402                   & \Letter \ \ \href{mailto:zlabe@climatecentral.org}{zlabe@climatecentral.org}\\
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Eayrs, C. and \textbf{Z.M. Labe} (2025). The future of sea ice. (\textit{submitted})
