...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, Y. Peings, and G. Magnusdottir ($2018$). Contributions of ice thickness to the atmospheric response from projected Arctic sea ice loss. (\textit{accepted to Geophysical Research Letters})
...
\vspace*{0.05in}
\begin{tabular}{@{}p{0.8in}p{4in}}
$2018 -$Present & Journal Manuscript Referee - \textit{Journal of Climate}\\
