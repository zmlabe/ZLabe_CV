...
\rfoot{{\footnotesize \textcolor{MidnightBlue}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 20}}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} Using explainable machine learning to evaluate climate change projections. \textit{Atmosphere and Ocean Climate Dynamics Seminar}, Yale University, CT (Oct 2023). (\textbf{Invited-Remote}) (\textit{Upcoming!})
...
Sep. 2023 & \textit{Guest lecture for ``Observing and Modeling Climate Change (EES 3506/5506)''}, Contrasting polar climate change in the past, present, and future, Temple University, PA. (\textbf{Invited-Remote}) (\textit{Upcoming!})\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter ($>$64,200 followers)} \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
