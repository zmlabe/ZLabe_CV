...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2021), [The Arctic] Sea surface temperature [in ``State of the Climate in 2020'']. Bulletin of the American Meteorological Society (\textit{accepted})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$38,900 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
