...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Zhang, Y., B.M. Ayyub, J.F. Fung, and \textbf{Z.M. Labe} (2024). Attributing extreme events to climate change for infrastructure adaptation: methods, benefits, and future research needs. (\textit{accepted})
