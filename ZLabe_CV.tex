...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Jong, B-T., \textbf{Z.M. Labe}, T.L. Delworth, and W.F. Cooke. Reversal of extreme precipitation trend over the Northeast US in response to aggressive climate mitigation in GFDL SPEAR, \textit{EarthArXiv}, DOI:10.31223/X59443 (\textit{submitted}) \href{https://doi.org/10.31223/X59443}{[Preprint]}
...
\item Joh, Y., S-W. Yeh, T.L. Delworth, \textbf{Z.M. Labe}, A.T. Wittenberg, W.F. Cooke, J. Lou, and Y-G. Park (2025). Evolving synchronization of Gulf Stream and Kuroshio-Oyashio Extension in a changing climate. (\textit{accepted})
...
\item Zhang, Y. and \textbf{Z.M. Labe} (2025). Drivers of CO\textsubscript{2} Emissions and Climate Extremes. (\textit{submitted})
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} Visualizing our changing climate in real-time, \textit{Terra.do}, Remote Presentation (July 2025). (\textbf{Invited-Keynote})
