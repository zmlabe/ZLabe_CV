...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.,} G. Magnusdottir, and H.S. Stern ($2018$), Variability of Arctic sea ice thickness using PIOMAS and the CESM Large Ensemble. (\textit{accepted to Journal of Climate})
\end{etaremune}
