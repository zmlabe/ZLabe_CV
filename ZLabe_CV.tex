...
\begin{tabular}{@{}p{0.9in}p{4in}}
 ...
 & Journal Manuscript Referee \href{https://www.webofscience.com/wos/author/record/J-4764-2019}{[Web of Science; $>$100 reviews]} - \textit{Artificial Intelligence for the Earth Systems}, \textit{Atmosphere-Ocean}, 
 \end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
& \textit{Atmospheric Research}, \textit{Atmosphere}, \textit{Bulletin of the American Meteorological Society}, \textit{Climatic Change}, \textit{Climate Dynamics}, \textit{Communications Earth \& Environment}, \textit{Environmental Data Science}, \textit{Environmental Research: Climate}, \textit{Environmental Research Letters}, \textit{Geophysical Research Letters}, \textit{Geosciences}, \textit{IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing}, \textit{International Journal of Climate}, \textit{Journal of Climate}, \textit{JGR: Atmospheres}, \textit{JGR: Machine Learning and Computation}, \textit{Journal of Glaciology}, \textit{Nature Climate Change}, \textit{Nature Communications}, \textit{Polar Geography}, \textit{Remote Sensing}, \textit{Science Advances}, \textit{Scientific Data}, \textit{Scientific Reports}, \textit{Weather}, \textit{Weather and Climate Dynamics} \\
