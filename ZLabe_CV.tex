...
\rfoot{{\footnotesize Zachary Labe \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 7}}
...
\name{\Huge{\textbf{\textcolor{black}{Zachary M. Labe}}} \vspace*{.1in}}

\begin{resume}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Contact Information}}}
...
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Research Interests}}}
...
\vspace{-0.1in}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent\textcolor{PineGreen}{\makebox[\linewidth][r]{\rule{\textwidth}{5pt}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-0.3in}

\section{\sc \large{\textcolor{PineGreen}{Education}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Scientific Research Experience}}}
\vspace*{0.05in}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \large{\textcolor{PineGreen}{Publications}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Oral Presentations}}}
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Poster Presentations}}}
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Fellowships and\\ Awards}}}
\vspace*{0.04in}
...
\section{\sc \textcolor{PineGreen}{\large{Teaching and Outreach}}}
...
\noindent\textcolor{PineGreen}{\makebox[\linewidth][r]{\rule{\textwidth}{5pt}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Professional Activities}}}
\vspace*{0.05in}
\begin{tabular}{@{}p{0.8in}p{4in}}
$2019 -$Present & Student Board Member, American Meteorological Society's Board on Societal Impacts\\
$2018 -$Present & Journal Manuscript Referee \href{https://publons.com/author/1521902/zachary-labe#profile}{[Publons]} - \textit{Geophysical Research Letters}, \textit{Journal of Climate}, \textit{Journal of Glaciology}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Professional Travel}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Technical \\ Skills}}}
\vspace*{0.05in}
...
\noindent\textcolor{PineGreen}{\makebox[\linewidth][r]{\rule{\textwidth}{5pt}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{PineGreen}{\large{Graduate Coursework}}}
\vspace{-0.1in}
...
\section{\sc \textcolor{PineGreen}{\large{Undergraduate Coursework}}}
\vspace{-0.1in}
\begin{tabular}{@{}p{2.2in}p{3in}}
\vspace*{0.04in}
\begin{list1}
...
\section{\sc \textcolor{PineGreen}{\large{News and\\ Media}}}
\vspace*{0.04in}
\begin{tabular}{@{}p{0.8in}p{4in}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-0.3in}
\section{\sc \textcolor{PineGreen}{\large{Personal Interests}}}
