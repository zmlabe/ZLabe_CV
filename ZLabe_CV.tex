...
\rfoot{{\footnotesize \textcolor{Cerulean}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 17}}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} and E.A. Barnes. Temporary slowdowns in decadal warming predictions by a neural network, \textit{CLIVAR Climate Dynamics Panel (CDP) annual workshop: External versus internal variability on decadal and longer time scales}, Virtual Workshop (Oct 2022). 
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$49,600 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
