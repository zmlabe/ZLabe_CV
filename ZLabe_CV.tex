...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Kalashnikov, D., F. Davenport, \textbf{Z. Labe}, P. Loikith, J. Abatzoglou, and D. Singh (2024). Predicting cloud-to-ground lightning in the Western United States from the large-scale environment using explainable neural networks. (\textit{accepted to Journal of Geophysical Research: Atmospheres})
