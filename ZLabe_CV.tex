...
\rfoot{{\footnotesize \textcolor{MidnightBlue}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 21}}
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Bushuk, M., and Coauthors (including \textbf{Z.M. Labe}). Predicting September Arctic sea ice: a multi-model seasonal skill comparison. (\textit{submitted})
\item Zhang, Y., B.M. Ayyub, J.F. Fung, and \textbf{Z.M. Labe}. Attributing extreme events to climate change for infrastructure adaptation: methods, benefits, and future research needs. (\textit{submitted})
...
\item \textbf{Labe, Z.M.} Applications of machine learning for climate change and variability. \textit{Department of Environmental Sciences Seminar}, Rutgers University, New Brunswick, NJ (Feb 2024). (\textbf{Invited}) (\textit{Upcoming!})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter ($>$65,500 followers)} \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
