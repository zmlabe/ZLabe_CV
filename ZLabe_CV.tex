...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item M.-L. Timmermans and \textbf{Z.M. Labe} (2020), Sea Surface Temperature [in Arctic Report Card 2020], NOAA (\textit{accepted})
\item Peings, Y., \textbf{Z.M. Labe}, and G. Magnusdottir (2020), Are 100 ensemble members enough to capture the remote atmospheric response to $+$2$^{\circ}$C Arctic sea ice loss? Journal of Climate (\textit{revised})
\end{etaremune}
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$32,400 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
