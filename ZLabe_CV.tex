...
\rfoot{{\footnotesize \textcolor{Cerulean}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 7}}
...
\name{\fcolorbox{Cerulean}{Cerulean}{\Huge{\textbf{\textcolor{White}{Zachary M. Labe \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \:\ \ \ \ \ \ \ \ \ \ \ \ \! \! \ }}} \vspace*{.1in}}}

\begin{resume}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Contact Information}}}
...
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Research Interests}}}
...
\section{\sc \large{\textcolor{Cerulean}{Education}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Scientific Research Experience}}}
\vspace*{0.05in}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \large{\textcolor{Cerulean}{Publications}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Oral Presentations}}}
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Poster Presentations}}}
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Fellowships and\\ Awards}}}
\vspace*{0.04in}
...
\section{\sc \textcolor{Cerulean}{\large{Teaching and Outreach}}}
...
\noindent\textcolor{Cerulean}{\makebox[\linewidth][r]{\rule{\textwidth}{5pt}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Professional Activities}}}
\vspace*{0.05in}
\begin{tabular}{@{}p{0.8in}p{4in}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Professional Travel}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Technical \\ Skills}}}
\vspace*{0.05in}
...
\noindent\textcolor{Cerulean}{\makebox[\linewidth][r]{\rule{\textwidth}{5pt}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc \textcolor{Cerulean}{\large{Graduate Coursework}}}
\vspace{-0.1in}
...
\section{\sc \textcolor{Cerulean}{\large{Undergraduate Coursework}}}
\vspace{-0.1in}
\begin{tabular}{@{}p{2.2in}p{3in}}
\vspace*{0.04in}
\begin{list1}
...
\section{\sc \textcolor{Cerulean}{\large{News and\\ Media}}}
\vspace*{0.04in}
\begin{tabular}{@{}p{0.8in}p{4in}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-0.3in}
\section{\sc \textcolor{Cerulean}{\large{Personal Interests}}}
