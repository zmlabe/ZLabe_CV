...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} and E.A. Barnes. Climate model evaluation with explainable neural networks, \textit{3rd NOAA Workshop on Leveraging AI in Environmental Sciences}, Virtual Workshop (Sep 2021). 
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$38,200 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
