...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2021), Predicting slowdowns in decadal climate warming trends with explainable neural networks. (\textit{submitted}) \href{https://www.essoar.org/doi/abs/10.1002/essoar.10508874.1}{[Preprint]}
\item Witt, J.K., \textbf{Z.M. Labe}, A.C. Warden, and B.A. Clegg (2021). Visualizing Uncertainty in Hurricane Forecasts with Dynamic Ensembles. (\textit{submitted})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$41,600 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
