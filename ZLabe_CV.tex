...
large-scale climate variability $\LargerCdot$ atmospheric teleconnections $\LargerCdot$ stratospheric coupling $\LargerCdot$ Arctic sea ice $\LargerCdot$ data science methods $\LargerCdot$ science communication
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2021), Detecting climate signals using explainable AI with single-forcing large ensembles. Journal of Advances in Modeling Earth Systems (\textit{revised}) \href{https://www.essoar.org/doi/10.1002/essoar.10505762.2}{[Preprint]}
\item Witt, J.K., \textbf{Z.M. Labe}, A.C. Warden, and B.A. Clegg (2021). Dynamic ensemble visualizations to support understanding for uncertainty in hurricane trajectories. In prep for Wea., Climate, and Soc. (\textit{drafted})
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
May 2021 & \textit{ABC News}, Climate summit for the ABC network (\textbf{Panelist-Remote})\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$35,500 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
