...
\rfoot{{\footnotesize \textcolor{Cerulean}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 9}}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} Melting Ice: Context, Causes, and Consequences of Polar Amplification. \textit{Kavli Frontiers of Science, National Academy of Science}, Jerusalem, Israel (Sep 2019). (\textbf{Invited})
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} QBO affects atmospheric response to Arctic sea-ice decline, \textit{Kavli Frontiers of Science, National Academy of Science}, Jerusalem, Israel (Sep 2019). \href{https://sites.uci.edu/zlabe/files/2019/09/ZLabe_BigIdeaPoster_QBO.pdf}{[Poster]}
