...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.,} G. Magnusdottir, and H.S. Stern ($2017$), Variability of Arctic sea ice thickness using PIOMAS and the CESM Large Ensemble. (\textit{in revision})
\end{etaremune}
