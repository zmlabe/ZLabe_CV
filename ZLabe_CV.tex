...
\rfoot{{\footnotesize Zachary Labe \\ Curriculum Vit\ae, Page \textbf{\thepage} of 5}}
...
Ph.D. Candidate, $2101$ Croul Hall                                                            & \Telefon \ \ $717.602.5959$ \\
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, Y. Peings, and G. Magnusdottir ($2018$). Contributions of ice thickness to the atmospheric response from projected Arctic sea ice loss. (\textit{in prep.})
\end{etaremune}
...
\vspace*{0.04in}
\begin{tabular}{@{}p{0.8in}p{4in}}
Mar. $2018$ & \textit{United States Senate -- Senator Sheldon Whitehouse (D--RI)}, ``Time to wake up up: Climate Progress" (\textbf{Supplied Graphic}). \href{https://www.youtube.com/watch?v=C_E5OQgt2SE}{[Speech]}\\
