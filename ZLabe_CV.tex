...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2021), [The Arctic] Sea surface temperature [in ``State of the Climate in 2020'']. Bull. Amer. Meteor. Soc. (\textit{in revision})
...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2021), Detecting climate signals using explainable AI with single-forcing large ensembles. Journal of Advances in Modeling Earth Systems (\textit{in revision}) \href{https://www.essoar.org/doi/10.1002/essoar.10505762.1}{[Preprint]}
\end{etaremune}
...
\item \textbf{Labe, Z.M.} Using explainable AI to detect patterns in climate models. \textit{Young Scientist Symposium on Atmospheric Research}, Colorado State University, CO (Mar 2021). (\textbf{Remote})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$34,700 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
