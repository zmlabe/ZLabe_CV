...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Gum, J., et al. (including \textbf{Z.M. Labe}) (2026). Impactful Datasets in Earth, Space, and Environmental Sciences: Highlighting the Data that Transform Research. (\textit{submitted})
