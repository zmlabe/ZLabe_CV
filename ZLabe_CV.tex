...
\rfoot{{\footnotesize \textcolor{MidnightBlue}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 32}}
...
\item Gum, J., et al. (including \textbf{Z.M. Labe}) (2026). Impactful Datasets in Earth, Space, and Environmental Sciences: Highlighting the Data that Transform Research. \textit{AGU Advances}, DOI:10.1029/2026AV002623. \href{https://doi.org/10.1029/2026AV002623}{[Article]}
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2026). [The Arctic] Sea surface temperature [in ``State of the Climate in 2025'']. \textit{Bulletin of the American Meteorological Society}, DOI:10.1175/BAMS-D-26-0123.1. \href{https://doi.org/10.1175/BAMS-D-26-0123.1}{[Article]}
\item Zhang, Y. and \textbf{Z.M. Labe} (2026). Adapting Infrastructure to a Changing Climate with Extreme Event Attribution Assessments. \textit{Climate-Resilient Structures and Infrastructures}, DOI:10.1201/9781003567332-6. \href{https://www.taylorfrancis.com/chapters/edit/10.1201/9781003567332-6/adapting-infrastructure-changing-climate-extreme-event-attribution-assessments-yating-zhang-zachary-labe}{[Article]}
\item Jong, B-T., \textbf{Z.M. Labe}, T.L. Delworth, and W.F. Cooke (2026). Reversal of extreme precipitation trends over the Northeast US in response to aggressive climate mitigation in GFDL SPEAR, \textit{Environmental Research Letters}, DOI:10.1088/1748-9326/ae51a6. \href{https://doi.org/10.1088/1748-9326/ae51a6}{[Article]}
\item Joh, Y., S-W. Yeh, T.L. Delworth, \textbf{Z.M. Labe}, A.T. Wittenberg, W.F. Cooke, J. Lou, and Y-G. Park (2026). Evolving synchronization of Gulf Stream and Kuroshio-Oyashio Extension in a changing climate. \textit{Science Advances}, DOI: 10.1126/sciadv.adx6366. \href{https://www.science.org/doi/10.1126/sciadv.adx6366}{[Article]}
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2025). Sea surface temperature [in ``Arctic Report Card 2025''], \textit{NOAA}, DOI:10.25923/pz7y-3b10. \href{https://arctic.noaa.gov/report-card/report-card-2025/sea-surface-temperature-2025/}{[Article]}
\item Eayrs, C. and \textbf{Z.M. Labe} (2025). The future of sea ice. \textit{Comprehensive Cryospheric Science and Environmental Change}, DOI:10.1016/B978-0-323-85242-5.00050-6. \href{https://doi.org/10.1016/B978-0-323-85242-5.00050-6}{[Chapter]}
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Witt, J.K., B.A. Clegg, \textbf{Z.M. Labe}, L.D. Blalock (2026). Enhanced visualization of low probability trajectories. (\textit{accepted})
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2026). Sea surface temperature [in ``Arctic Report Card 2026'']. (\textit{submitted})
\item Lenssen, N., D.P. Schneider, A.S. Phillips, R. Johnson. \textbf{Z.M. Labe}, and C. Deser (2026). The NSF NCAR Climate Data Guide: A Bridge Between Data Experts and Users. (\textit{submitted})
\item Eayrs, C., \textbf{Z.M. Labe}, F. Massonnet, T. Tian, and M. M\"uller (2026). Reliable AI sea ice forecasts depend on sustained observations. (\textit{submitted})
\item Zhang, Y. and \textbf{Z.M. Labe} (2026). Drivers of CO\textsubscript{2} Emissions and Climate Extremes. (\textit{submitted})
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% OLD PAPERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \item Witt, J.K., \textbf{Z.M. Labe}, and B.A. Clegg (2026). An Alternative to the ``Cone of Uncertainty'' that is Flexible, Intuitive, and Desirable for Communicating Hurricane Forecasts. (\textit{submitted})
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Eayrs, C., L. Zampieri, L. von Albedyll, J. Brajard, M. Bushuk, S. Driscoll, I. Fenton, W. Gregory, L. Hoffman, W. De Jager, \textbf{Z.M. Labe}, X. Liu, F. Massonnet, A. McDonald, Y. Nie, M. Rogers, and T. Tian, April 2026: The ORCAS Community Workshop: Connecting Observations and AI Sea Ice Prediction Systems - Workshop Report. Zenodo, DOI: 10.5281/zenodo.19543215. \href{https://doi.org/10.5281/zenodo.19543215}{[Article]}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} Changing Winter in New York State, \textit{11th Annual Salt Summit}, Albany, NY (Oct 2026). (\textbf{Invited})
\item \textbf{Labe, Z.M.} Bridging weather and climate communication through data storytelling, \textit{16th Annual Black River Watershed Conference}, Lowville, NY (Jun 2026). (\textbf{Invited-Keynote})
\item \textbf{Labe, Z.M.} Lecture II: Arctic Sea Ice, \textit{CAMAS 2026 Early-Career School}, Monterey, CA (Apr 2026). (\textbf{Invited})
\item \textbf{Labe, Z.M.} Applications of explainable machine learning for climate variability and change, \textit{Department of Earth and Atmospheric Sciences}, Cornell University, Ithaca, NY (Mar 2026). (\textbf{Invited})
\item \textbf{Labe, Z.M.} The urgency of effectively communicating climate data, \textit{Climate Solutions Now 2026}, Remote Presentation (Feb 2026). (\textbf{Invited})
\item \textbf{Labe, Z.M.} Visualizing our changing climate in real-time, \textit{Terra.do}, Remote Presentation (Jul 2025). (\textbf{Invited-Keynote})
\item \textbf{Labe, Z.M.} Monitoring our changing climate through data-driven stories, \textit{8th C3S General Assembly}, Valencia, Spain (Jun 2025). (\textbf{Invited-Remote})
...
\item \textbf{Labe, Z.M.} and E.A. Barnes. Using neural networks to explore regional climate patterns in single-forcing large ensembles, \textit{2021 AGU Annual Meeting}, New Orleans, LA (Dec 2021). (\textbf{Invited-Remote}) \href{https://agu.confex.com/agu/fm21/meetingapp.cgi/Paper/798039}{[Abstract]}
\item \textbf{Labe, Z.M.} and E.A. Barnes. Evaluating global climate models using simple, explainable neural networks, \textit{2021 AGU Annual Meeting}, New Orleans, LA (Dec 2021) (\textbf{Invited-Remote}) \href{https://agu.confex.com/agu/fm21/meetingapp.cgi/Paper/797879}{[Abstract]}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, and Y. Zhang. Designing Climate-Resilient Infrastructure with Extreme Event Attribution and Decadal Climate Prediction Systems, \textit{21st Symposium on Societal Applications: Policy, Research and Practice}, Houston, TX (Jan 2026). \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/470992}{[Abstract]}
...
\item \textbf{Labe, Z.M.}, N.C. Johnson, and T.L Delworth. Identifying the drivers of the observed springtime cooling trend in northern North America with large ensemble simulations, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1111909}{[Abstract]} \href{https://zacklabe.files.wordpress.com/2022/12/labejohnsondelworth_agu_largeensembles2022_poster.pdf}{[Poster]}
\item \textbf{Labe, Z.M.}, E.A. Barnes, and J. Hurrell. Detecting the regional emergence of climate signals with machine learning in a set of stratospheric aerosol injection simulations, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1110391}{[Abstract]} \href{https://zacklabe.files.wordpress.com/2022/12/labebarneshurrell_agu_sai2022_poster.pdf}{[Poster]}
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Jong, B.-T., T.L. Delworth, \textbf{Z.M. Labe}, and W.F. Cooke. Changes in extreme precipitation across the Northeast U.S. under different climate scenarios, \textit{2026 Annual Meeting of the EMS}, Utrecht, The Netherlands (Sep 2026). \href{https://doi.org/10.5194/ems2026-565}{[Abstract]} 
\item Jong, B.-T., \textbf{Z.M. Labe}, T.L. Delworth, and W.F. Cooke. Reversal of extreme precipitation trends over the Northeast US in response to aggressive climate mitigation, \textit{EGU General Assembly}, Vienna, Austria (May 2026). \href{https://doi.org/10.5194/egusphere-egu26-5420}{[Abstract]}
\item Joh, Y., S-W. Yeh, T.L. Delworth, \textbf{Z.M. Labe}, A.T. Wittenberg, W.F. Cooke, J. Lou, and Y-G. Park. Evolving synchronization of the Gulf Stream and Kuroshio-Oyashio Extension in a changing climate, \textit{Ocean Sciences Meeting 2026}, Glasgow, Scotland (Feb 2026). \href{https://agu.confex.com/agu/osm26/meetingapp.cgi/Paper/2011907}{[Abstract]}
\item Mecray, E., \textbf{Z.M. Labe}, A. Smith, and J. Brady. Climate Central Science and Services to Support Information Needs Across Sectors, Hazards and Geographies, \textit{30th Conference on Applied Climatology}, Houston, TX (Jan 2026). \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/477971}{[Abstract]}
\item Giguere, J., \textbf{Z.M. Labe}, D.M. Gilford, and K. Dahl. A Method for Rapid, Global Precipitation Attribution, \textit{39th Conference on Climate Variability and Change}, Houston, TX (Jan 2026). \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/467538}{[Abstract]}
\item Ishraque, F., M.A. Shadab, O. Lauter, N. Narayanan, K. Shionalyn, M.N. Schaberg, \textbf{Z.M. Labe}, S.S. Gaikwad, M. Nicewonger, and R. Narayanan. Assessing challenges for polar early career scientists during science policy upheaval, 2025 AGU Annual Meeting, New Orleans, LA (Dec 2025). \href{https://agu.confex.com/agu/agu25/meetingapp.cgi/Paper/1904944}{[Abstract]}
...
\item Kalashnikov, D.A., J.T. Abatzoglou, F.V. Davenport, \textbf{Z.M. Labe}, P.C. Loikith, D.E. Touma, and D. Singh. Projecting cloud-to-ground lightning and wildfire ignition risk in the western United States, \textit{2024 AGU Annual Meeting}, Washington, DC (Dec 2024). \href{https://agu.confex.com/agu/agu24/meetingapp.cgi/Paper/1570366}{[Abstract]}
\item Bushuk, M., et al. (including \textbf{Z.M. Labe}). Predicting September Arctic Sea Ice: A Multi-Model Seasonal Skill Comparison, \textit{2024 AGU Annual Meeting}, Washington, DC (Dec 2024). \href{https://agu.confex.com/agu/agu24/meetingapp.cgi/Paper/1633366}{[Abstract]}
\item Schaberg, M.N., \textbf{Z.M. Labe}, M.A. Shadab, L. Ashokkumar, S. Vanek, O. Lauter, and K. Shionalyn. Empowering the Polar Science Community: A Decade of USAPECS in Supporting Early Career Researchers Globally, \textit{2024 AGU Annual Meeting}, Washington, DC (Dec 2024). \href{https://agu.confex.com/agu/agu24/meetingapp.cgi/Paper/1696092}{[Abstract]}
\item Johnson, N.C., M. Park, J. Clark, T.L. Delworth, L. Jia, F. Lu, W. Cooke, C. McHugh, and \textbf{Z.M. Labe}. Progress in the seasonal prediction of extreme weather in GFDL’s SPEAR, \textit{2024 AGU Annual Meeting}, Washington, DC (Dec 2024). \href{https://agu.confex.com/agu/agu24/meetingapp.cgi/Paper/1531073}{[Abstract]}
\item Park, M., N.C. Johnson, J. Clark, D. Yoon, \textbf{Z.M. Labe}, C. McHugh, and L. Jia. A Linkage between atmospheric rivers, blocking and North American heatwaves in high resolution climate model simulations, \textit{2024 AGU Annual Meeting}, Washington, DC (Dec 2024). \href{https://agu.confex.com/agu/agu24/meetingapp.cgi/Paper/1543440}{[Abstract]}
...
\item Ashokkumar, L, \textbf{Z.M. Labe}, M.A. Shadab, O. Lauter and E.P. Schreiber. Advancing inclusion, diversity, equity, and accessibility (IDEA) in the polar sciences by USAPECS, \textit{2023 AGU Annual Meeting}, San Francisco, CA (Dec 2023). \href{https://agu.confex.com/agu/fm23/meetingapp.cgi/Paper/1431736}{[Abstract]}
\item Meem, T.J., \textbf{Z.M. Labe}, W.F. Cooke, T.L. Delworth, and V. Ramaswamy. Role of anthropogenic aerosols on the South Asian summer monsoon in a high-resolution large ensemble, \textit{2023 AGU Annual Meeting}, San Francisco, CA (Dec 2023). \href{https://agu.confex.com/agu/fm23/meetingapp.cgi/Paper/1291065}{[Abstract]}
\item Kalashnikov, D.A., F.V. Davenport, \textbf{Z.M. Labe}, P.C. Loikith, J. Abatzoglou, and D. Singh. Using deep learning to predict cloud-to-ground lightning in the western United States, \textit{2023 AGU Annual Meeting}, San Francisco, CA (Dec 2023). \href{https://agu.confex.com/agu/fm23/meetingapp.cgi/Paper/1331607}{[Abstract]}
\item Johnson, N.C., L. Jia, \textbf{Z.M. Labe}, T.L. Delworth, F. Lu, and C.E. McHugh. Sources of seasonal extreme heat predictability diagnosed from the GFDL seamless System for Prediction and EArth System Research (SPEAR), \textit{2023 AGU Annual Meeting}, San Francisco, CA (Dec 2023). \href{https://agu.confex.com/agu/fm23/meetingapp.cgi/Paper/1293219}{[Abstract]}
...
\item Ashokkumar, L., L. Weinberg, \textbf{Z.M. Labe}, E. Schreiber, A. Taitt, and M. Dryak. Progress and challenges by early career polar scientists (USAPECS) in addressing inclusivity, diversity, equity, and accessibility, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1192493}{[Abstract]}
\item Po-Chedley, S., E.A. Barnes, C. Bonfils, J. Fasullo, \textbf{Z.M. Labe}, B. Santer, and N. Siler. Substantial contribution of internal variability to satellite-era tropospheric warming inferred from CMIP6 large ensembles, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1095614}{[Abstract]}
\item Lehner, F., C. Deser, J. Fasullo, E. Fischer, P. Hitchcock, \textbf{Z.M. Labe}, S. Milinski, M. Röthlisberger, I. Simpson, S. Sippel, and J. Zscheischler. Emergence of multiple feedbacks in the extreme and persistent warmth over Siberia in 2020, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1190729}{[Abstract]}
\item Bushuk, M., et al. (including \textbf{Z.M. Labe}). A multi-model comparison of September Arctic sea ice seasonal prediction skill, \textit{2022 AGU Annual Meeting}, Chicago, IL (Dec 2022). \href{https://agu.confex.com/agu/fm22/meetingapp.cgi/Paper/1179488}{[Abstract]}
...
\item Magnusdottir, G., \textbf{Z.M. Labe}, and Y. Peings. How does the atmospheric response to Arctic sea-ice decline compare to the full effect of the Arctic Amplification? \textit{2020 AGU Annual Meeting}, Virtual Conference (Dec 2020). \href{https://agu.confex.com/agu/fm20/meetingapp.cgi/Paper/678706}{[Abstract]}
\item Peings, Y., \textbf{Z.M. Labe}, and G. Magnusdottir. Are 100 ensemble members enough to capture the remote atmospheric response to +2$^{\circ}$C Arctic sea ice loss? \textit{2020 AGU Annual Meeting}, Virtual Conference (Dec 2020). \href{https://agu.confex.com/agu/fm20/meetingapp.cgi/Paper/685885}{[Abstract]}
\item Magnusdottir, G., Y. Peings, and \textbf{Z.M. Labe}. Response to sea-ice loss under the Polar Amplification MIP protocol in extended ensembles of simulations. \textit{2019 AGU Annual Meeting}, San Francisco, CA (Dec 2019). \href{https://agu.confex.com/agu/fm19/meetingapp.cgi/Paper/553470}{[Abstract]}
...
\item Holman, A., R. Thoman, \textbf{Z.M. Labe}, and J.E. Walsh. Not Just Chance: Ocean and Atmospheric Factors in the Record Low Bering Sea Ice Winter of 2017-2018 and effects on health and safety, \textit{2018 AGU Annual Meeting}, Washington, DC (Dec 2018). \href{https://agu.confex.com/agu/fm18/meetingapp.cgi/Paper/451295}{[Abstract]}
\item Magnusdottir, G., \textbf{Z.M. Labe}, and Y. Peings. The role of the stratosphere, including the QBO, in Arctic to mid-latitude teleconnections associated with sea-ice forcing. \textit{2018 AGU Annual Meeting}, Washington, DC (Dec 2018). \href{https://agu.confex.com/agu/fm18/meetingapp.cgi/Paper/399117}{[Abstract]}
...
\begin{tabular}{@{}p{0.9in}p{4in}}
Sep. 2025 & Outstanding Reviewer Award - \textit{JGR: Machine Learning}\\
Mar. 2025 & Outstanding Reviewer Award - \textit{Environmental Research: Climate}\\
Sep. 2023 & Outstanding Reviewer Award - \textit{Geophysical Research Letters}\\
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
...
May 2021 & Outstanding Reviewer Award - \textit{Geophysical Research Letters}\\
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Sep. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from August 2026. (\textbf{Presenter-Remote})\\
Sep. 2026 & \textit{GSCC}, Online Press Briefing – Record High Ocean Warmth. (\textbf{Panelist-Remote})\\
Sep. 2026 & \textit{AGU Hydrology Section Student Subcommittee}, Navigating Academic Waters: The Scientist Behind the Science - The Power of Storytelling in Academic and Professional Spaces. (\textbf{Invited-Panelist-Remote}).\\
Aug. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from July 2026. (\textbf{Presenter-Remote})\\
Jul. 2026 & \textit{Covering Climate Now, Press Briefing}, Wildfires and Climate: Experts Help You Get the Story Right. (\textbf{Invited-Panelist-Remote}).\\
Jul. 2026 & \textit{Polar Bears International}, Chat Arctic Sea Ice with Two Climate Scientists | Arctic Sea Ice Day. (\textbf{Invited-Presenter-Remote})\\
Jul. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from June 2026. (\textbf{Presenter-Remote})\\
Jul. 2026 & \textit{GFDL/AOS Summer Internship Lecture Series}, Effective Scientific Presentations Workshop. (\textbf{Invited-Presenter-Remote})\\
Jul. 2026 & \textit{COLDEX Research Experience for Undergraduates}, Non-academic careers panel. (\textbf{Panelist-Invited-Remote})\\
Jun. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from May 2026. (\textbf{Presenter-Remote})\\
Jun. 2026 & \textit{The Weather and Climate Livestream}, Urgency of effective climate data communication, Remote Presentation. (\textbf{Invited Keynote})\\
May 2026 & \textit{Climate Action Campaign}, Media Briefing: how climate change is affecting extreme weather in Georgia, Remote Presentation. (\textbf{Panelist-Remote}).\\
May 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from April 2026. (\textbf{Presenter-Remote})\\
Apr. 2026 & \textit{USAPECS, Community Engagement Training Course}, Making accessible data visualization. (\textbf{Invited-Presenter-Remote}).\\
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
Apr. 2026 & \textit{ANTH/SOCI 3320: Indigenous Cultures of North America}, Introduction to rapid Arctic change. The University of Texas at El Paso, El Paso, TX. (\textbf{Invited-Guest Lecture-Remote}).\\
Apr. 2026 & \textit{Pennswood Village}, The rapidly changing Arctic and its far-reaching impacts, Newtown, PA. (\textbf{Invited-Presenter})\\
Apr. 2026 & \textit{GEO 371T/391: Climate Data}, Creative and effective climate data visualization. The University of Texas at Austin, Austin, TX. (\textbf{Invited-Guest Lecture-Remote}).\\
Apr. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from March 2026. (\textbf{Presenter-Remote})\\
Mar. 2026 & \textit{American Camp Association, Climate Symposium}, Ask a meteorologist: Extreme weather and the climate change connection. (\textbf{Invited-Organizer-Remote}).\\
Mar. 2026 & \textit{Covering Climate Now, Press Briefing}, ``Virtually Impossible Heat'' \& the Future of the American West. (\textbf{Invited-Panelist-Remote}).\\
Mar. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from February 2026. (\textbf{Presenter-Remote})\\
Mar. 2026 & \textit{World Water Week 2026 at UTEP and UACJ}, Climate change and human adaptations in the Arctic, El Paso, TX. (\textbf{Invited-Panelist-Remote}).\\
Mar. 2026 & \textit{Cornell University, Climate Change Seminar}, Connecting global climate change to local impacts, Ithaca, NY. (\textbf{Invited-Presenter}).\\
Mar. 2026 & \textit{National Garden Clubs}, Environmental School Course 3, St. Louis, MO. (\textbf{Invited-Presenter-Remote}).\\
Feb. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from January 2026. (\textbf{Presenter-Remote})\\
Feb. 2026 & \textit{Horticultural Societies of Parkdale and Toronto}, Climate change extremes by the season, Toronto, Canada. (\textbf{Invited-Presenter-Remote}).\\
Jan. 2026 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from December 2025. (\textbf{Presenter-Remote})\\
Jan. 2026 & \textit{NOAA Global Ocean Monitoring and Observing}, Committee on Marine Transportation System Dialogue. (\textbf{Invited-Presenter-Remote}).\\
Dec. 2025 & \textit{Climate Central}, Climate Central's Monthly Briefing Highlights from November 2025. (\textbf{Presenter-Remote})\\
Nov. 2025 & \textit{Cooperative Atmospheric and Earth Science Assemble of Researchers}, Sharing complex research through effective communication techniques. (\textbf{Invited-Presenter-Remote}).\\
Nov. 2025 & \textit{EV228: Analysis of Environmental Data}, Data visualization for trusted science communication, Colorado College, Colorado Springs, CO. (\textbf{Invited-Guest Lecture-Remote}).\\
...
Apr. 2025 & \textit{Pennswood Village}, Our changing climate in the Northeastern United States, Newtown, PA. (\textbf{Invited-Presenter})\\
...
\begin{tabular}{@{}p{0.9in}p{4in}}
 ...
 & Hiring Committees - \textit{Climate Central Inc.}, \textit{NOAA OAR}\\
 ...
 & Journal Manuscript Referee \href{https://www.webofscience.com/wos/author/record/J-4764-2019}{[Web of Science; $>$100 reviews]} - \textit{Artificial Intelligence for the Earth Systems}, \textit{Atmosphere-Ocean}, \textit{Atmospheric Research}, \textit{Atmosphere}, \textit{Bulletin of the American Meteorological Society}, \textit{Climatic Change}, \textit{Climate Dynamics}, \textit{Communications Earth \& Environment}, \textit{Earth's Future}, \textit{Environmental Data Science}, \textit{Environmental Research: Climate}, \textit{Environmental Research Letters}, \textit{Geophysical Research Letters}, \textit{Geosciences}, \textit{IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing}, \textit{International Journal of Climate}, \textit{International Journal of Disaster Risk Science}, \textit{Journal of Climate}, \textit{JGR: Atmospheres}, \textit{JGR: Machine Learning and Computation}, \textit{Journal of Advances in Modeling Earth Systems}, \textit{Journal of Glaciology}, \textit{Nature Climate Change}, \textit{Nature Communications}, \textit{Polar Geography}, \textit{Remote Sensing}, \textit{Science Advances}, \textit{Scientific Data}, \textit{Scientific Reports}, \textit{The Cryosphere}, \textit{Weather}, \textit{Weather and Climate Dynamics} \\
2026-Present & Subject Matter Expert - AMS Certificate in Climate Science\\
2026-Present & Board Member - AMS Committee on Climate Services\\
2025-Present & Associate Editor - \textit{Atmospheric Science Letters}\\
2025-Present & Task Team - WMO's WWRP, PCAPS/SCOR ORCAS\\
2023-Present & Associate Editor - \textit{Journal of Climate}\\
2020-Present & Board of Advisors for the NCAR Climate Data Guide\\
2023-2025 & Member - Fresh Eyes on CMIP (WCRP Working Group)\\
2021-2025 & Board Member - US Association of Polar Early Career Scientists\\
2023-2025 & Contributing Editor - Carbon Brief\\
2023-2025 & NOAA GFDL Internal Reviewer\\
...
2021-2024 & Guest Editor - Special Issue for \textit{Atmospheric Science Letters}\\
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Jun. 2026 & 2nd Conference on Attribution Science \& Climate Law. (Virtual)\\
Apr. 2026 & CAMAS 2026 Workshop and Early-Career School, Monterey, CA\\
Feb. 2026 & PCAPS/SCOR ORCAS, Community Workshop: Connecting Observations and AI Sea Ice Prediction Systems. (Virtual)\\
Jan. 2026 & AMS Houston Area Heat Workshop, Houston, TX\\
...
\vspace*{0.04in}
\begin{tabular}{@{}p{0.9in}p{4in}}
Sep 2026 & \textit{Carbon Brief}, ```Concerning' low sea ice persists as Antarctic hits third-lowest winter peak (\textbf{Quoted}). \href{https://www.carbonbrief.org/concerning-low-sea-ice-persists-as-antarctic-hits-third-lowest-winter-peak?utm_content=buffer95d24&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer}{[Article]}\\
Sep 2026 & \textit{USA Today}, ``Autumnal equinox marks start of fall, but heat could stick around'' (\textbf{Quoted}). \href{https://www.usatoday.com/story/news/weather/2026/09/22/when-is-autumnal-equinox-fall-begins/91810272007/}{[Article]}\\
Sep 2026 & \textit{Mongabay}, ``Global ocean breaks records with 100 days of heat as El Ni\~{n}o adds new threat'' (\textbf{Quoted}). \href{https://news.mongabay.com/2026/09/global-ocean-breaks-records-with-100-days-of-heat-as-el-nino-adds-new-threat/}{[Article]}\\
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
Sep 2026 & \textit{RFI}, ``How 100 days of record ocean heat is reshaping life in and around the seas'' (\textbf{Quoted}). \href{https://www.rfi.fr/en/environment/20260911-how-100-days-of-record-ocean-heat-is-reshaping-life-in-and-around-the-seas}{[Article]}\\
Sep 2026 & \textit{LA Times}, ``August is tied for the world’s hottest month ever recorded'' (\textbf{Quoted}). \href{https://www.latimes.com/environment/story/2026-09-10/august-is-tied-for-worlds-hottest-month-ever-recorded}{[Article]}\\
Sep 2026 & \textit{Life Science}, ```A worrying snapshot': Satellite image shows large patches of open water less than 40 miles from the North Pole'' (\textbf{Quoted}). \href{https://www.livescience.com/planet-earth/arctic/a-worrying-snapshot-satellite-image-shows-large-patches-of-open-water-less-than-40-miles-from-the-north-pole}{[Article]}\\
Aug 2026 & \textit{WUSF NPR}, ``Rising humid heat along the Gulf is partially thanks to the wind blowing record ocean temps ashore'' (\textbf{Quoted}). \href{https://www.wusf.org/weather/2026-08-31/rising-humid-heat-gulf-wind-blowing-record-ocean-temps-ashore}{[Article]}\\
Aug 2026 & \textit{Voice of Greece}, ``Infinitely Curious: Super El Ni\~{n}o: When the Pacific changes the world'' (\textbf{Interview}). \href{https://vog.ert.gr/ondemand/infinitely-curious-super-el-nino-when-the-pacific-changes-the-world-30-aug-2026/?lang=en}{[Recording]}\\
Aug 2026 & \textit{Scientific American}, ``Earth's oceans just hit their hottest temperature ever—it’s only going to get worse'' (\textbf{Quoted}). \href{https://www.scientificamerican.com/article/earths-oceans-just-hit-their-hottest-temperature-ever-recorded/}{[Article]}\\
Aug 2026 & \textit{CBC}, ```Super' El Ni\~{n}o didn't cause this year's fires and heat waves, but it's about to take us on a `wild ride''' (\textbf{Quoted}). \href{https://www.cbc.ca/news/climate/el-nino-2026-extreme-weather-9.7313170}{[Article]}\\
Aug 2026 & \textit{The Aspen Times}, ``Drought worsens in Colorado and across the West amid `lackluster monsoon''' (\textbf{Quoted}). \href{https://www.aspentimes.com/news/colorado-drought-worsens/}{[Article]}\\
Aug 2026 & \textit{DW News}, ``How climate change is teaming up with `Super El Ni\~{n}o''' (\textbf{Interview}). \href{https://www.youtube.com/watch?v=qX1JDtJLQhg}{[Article]}\\
Aug 2026 & \textit{ABC News}, ``Federal government ends support for key Arctic climate report'' (\textbf{Quoted}). \href{https://abcnews.com/US/federal-government-ends-support-key-arctic-climate-report/story?id=135559206}{[Article]}\\
Aug 2026 & \textit{E\&E News}, ``NOAA to end support for Arctic climate change report'' (\textbf{Quoted}). \href{https://www.eenews.net/articles/noaa-to-end-support-for-arctic-climate-change-report/}{[Article]}\\
Aug 2026 & \textit{The Hill}, ``NOAA pulls support from Arctic climate report'' (\textbf{Quoted}). \href{https://thehill.com/policy/energy-environment/6023519-noaa-ends-arctic-report-card-support/}{[Article]}\\
Aug 2026 & \textit{EOS}, ``Government Pulls Funding for the Arctic Report Card'' (\textbf{Quoted}). \href{https://eos.org/research-and-developments/government-pulls-funding-for-the-arctic-report-card}{[Article]}\\
Aug 2026 & \textit{KJZZ Phoenix}, ``Phoenix is already hot. How much more extreme will climate change make it?'' (\textbf{Interview}). \href{https://www.kjzz.org/science/2026-08-10/phoenix-is-already-hot-how-much-more-extreme-will-climate-change-make-it}{[Article]}\\
Aug 2026 & \textit{National Geographic}, ``U.S. cities are seeing more 90-degree days than ever. Is yours one of them?'' (\textbf{Quoted}). \href{https://www.nationalgeographic.com/environment/article/increase-extreme-heat-days-climate-change}{[Article]}\\
Aug 2026 & \textit{AP}, ``This summer isn’t breaking heat records — yet. Wait until El Ni\~{n}o kicks in, scientists say'' (\textbf{Interview}). \href{https://apnews.com/article/warming-heat-climate-change-summer-el-nino-ffd31dd358a894667c63f4c0a21cd677}{[Article]}\\
Jul 2026 & \textit{Copernicus}, ``From evidence to understanding: game-changing visualisations powered by C3S data'' (\textbf{Quoted}). \href{https://climate.copernicus.eu/evidence-understanding-game-changing-visualisations-powered-c3s-data}{[Article]}\\
Jul 2026 & \textit{CNN}, ``Fires, floods and record heat: This is the summer of compounding disasters'' (\textbf{Quoted}). \href{https://www.cnn.com/2026/07/20/climate/climate-compounding-disasters-summer}{[Article]}\\
Jul 2026 & \textit{Scientific American}, ``The science of why this summer has been so blistering hot'' (\textbf{Quoted}). \href{https://www.scientificamerican.com/article/why-have-there-been-so-many-record-breaking-heat-waves-this-summer/}{[Article]}\\
Jul 2026 & \textit{Grist}, ``The oceans are full of heat, and it's coming ashore'' (\textbf{Quoted}). \href{https://grist.org/climate/heatwaves-oceans-record-temperatures-el-nino/}{[Article]}\\
Jul 2026 & \textit{AP}, ``El Ni\~{n}o powers up as forecasters predict historic strength and a rainier winter for the US South'' (\textbf{Quoted}). \href{https://apnews.com/article/el-nino-climate-change-wetter-winter-heat-45ac1d144e3d34c791294c0ec9df7fb2}{[Article]}\\
Jul 2026 & \textit{LA Times}, ```‘Uncharted territory' as brewing El Niño, roasting oceans, heat bring risk for California, planet'' (\textbf{Quoted}). \href{https://www.latimes.com/california/story/2026-07-06/el-nino-warming-oceans-push-california-plant-into-uncharted-territory}{[Article]}\\
Jul 2026 & \textit{The Philadelphia Inquirer}, ``July in Philly has become 4.4 degrees hotter since 1940 on average. Nights are even warmer'' (\textbf{Interview}). \href{https://www.inquirer.com/news/philadelphia/hot-julys-philadelphia-climate-change-20260702.html}{[Article]}\\
Jul 2026 & \textit{Wisconsin Public Radio}, ``New analysis says Wisconsin’s hottest month is growing hotter for some cities'' (\textbf{Quoted}). \href{https://www.wpr.org/news/new-analysis-says-wisconsins-hottest-month-is-growing-hotter-for-some-cities}{[Article]}\\
Jun 2026 & \textit{AP}, ``What makes a ‘heat dome,’ and what does it mean?'' (\textbf{Quoted}). \href{https://apnews.com/article/climate-heat-dome-temperatures-baa416ddc73ce7e5b902bcf6686f0ff0}{[Article]}\\
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
Jun 2026 & \textit{Yahoo}, ``Climate experts warn record May CO2 could send summer 3.5 degrees above pre-industrial levels'' (\textbf{Quoted}). \href{https://www.yahoo.com/news/science/articles/climate-experts-warn-record-may-042000046.html}{[Article]}\\
Jun 2026 & \textit{Inside Climate News}, ``Scientists Warn of Summer Heat Spikes as Global Warming Edges Toward 2C'' (\textbf{Quoted}). \href{https://insideclimatenews.org/news/17062026/summer-heat-spike-as-global-warming-surges/}{[Article]}\\
May 2026 & \textit{Farm Progress}, ``Frozen out: Pennsylvania grower starts long slog to orchard recovery'' (\textbf{Quoted}). \href{https://www.farmprogress.com/orchard-crops/frozen-out-pennsylvania-grower-starts-long-slog-to-orchard-recovery}{[Article]}\\
May 2026 & \textit{LA Times}, ``This coming El Ni\~{n}o could be a monster. Will it bring epic rain to California this winter?'' (\textbf{Quoted}). \href{https://www.latimes.com/california/story/2026-05-14/el-nino-could-be-monster-what-would-it-mean-for-california}{[Article]}\\
May 2026 & \textit{Scientific American}, ``Carbon dioxide levels in the atmosphere just hit a `depressing' record high'' (\textbf{Quoted}). \href{https://www.scientificamerican.com/article/carbon-dioxide-levels-in-the-atmosphere-just-hit-a-depressing-record-high/}{[Article]}\\
Apr. 2026 & \textit{High Country News}, ``The ramifications of record-shattering heat on the West’s ecosystems'' (\textbf{Quoted}). \href{https://www.hcn.org/articles/the-ramifications-of-record-shattering-heat-on-the-wests-ecosystems/}{[Article]}\\
Apr. 2026 & \textit{Dr Gilbz}, ``The ``grim news'' that isn’t making headlines'' (\textbf{Interview}). \href{https://www.youtube.com/watch?v=GiWZNJHspnQ}{[Recording]}\\
Apr. 2026 & \textit{Grist}, ``Deep-diving robots help crack the mystery of Antarctica's vanishing sea ice'' (\textbf{Quoted}). \href{https://grist.org/oceans/deep-diving-robots-help-crack-the-mystery-of-antarcticas-vanishing-sea-ice/}{[Article]}\\
Apr. 2026 & \textit{E\&E News}, ``NOAA halts crucial dataset that helps measure Arctic sea ice'' (\textbf{Quoted}). \href{https://www.eenews.net/articles/noaa-halts-crucial-dataset-that-helps-measure-arctic-sea-ice/}{[Article]}\\
Mar. 2026 & \textit{Aspen Public Radio}, ``March heat wave is ``particularly alarming,'' but not our new normal, yet'' (\textbf{Interview}). \href{https://www.aspenpublicradio.org/environment/2026-03-27/march-heat-wave-is-particularly-alarming-but-not-our-new-normal-yet}{[Article]}\\
Mar. 2026 & \textit{Carbon Brief}, ```Very alarming' winter sees Arctic sea ice hit record-low for second year running'' (\textbf{Quoted}). \href{https://www.carbonbrief.org/very-alarming-winter-sees-arctic-sea-ice-hit-record-low-for-second-year-running/}{[Article]}\\
Mar. 2026 & \textit{Heatmap News}, ``A Once-in-a-4,433-Year Heat Wave Is Hitting the Western U.S.'' (\textbf{Quoted}). \href{https://heatmap.news/climate/march-heat-wave}{[Article]}\\
Mar. 2026 & \textit{Nevada Public Radio}, ``Spring is arriving earlier due to climate change'' (\textbf{Quoted}). \href{https://knpr.org/2026-03-06/spring-is-arriving-earlier-due-to-climate-change}{[Article]}\\
Feb. 2026 & \textit{Carbon Brief}, ``Q\&A: How Trump is threatening climate science in Earth's polar regions'' (\textbf{Quoted}). \href{https://www.carbonbrief.org/qa-how-trump-is-threatening-climate-science-in-earths-polar-regions/}{[Article]}\\
Jan. 2026 & \textit{Delphi Zero}, ``Letting the Ice Speak'' (\textbf{Interview}). \href{https://delphizero.substack.com/p/zack}{[Article]}\\
Jan. 2026 & \textit{Washington Post}, ``Melting ice may raise Greenland’s value. Trump’s fight may be just the start'' (\textbf{Quoted}). \href{https://www.washingtonpost.com/climate-environment/2026/01/18/melting-arctic-greenland-trump-2/}{[Article]}\\
Dec. 2025 & \textit{Washington Post}, ``How Trump's attacks on `climate alarmism' have already transformed U.S. science'' (\textbf{Quoted}). \href{https://www.washingtonpost.com/climate-environment/2025/12/24/trump-climate-science-funding-cuts/}{[Article]}\\
Dec. 2025 & \textit{Geographical Magazine}, ``How are scientists and health workers coping with Trump 2.0?'' (\textbf{Interview}). \href{https://geographical.co.uk/news/how-are-scientific-researchers-coping-with-trump-2-0}{[Article]}\\ 
Dec. 2025 & \textit{The Guardian}, ``Arctic endured year of record heat as climate scientists warn of `winter being redefined''' (\textbf{Quoted}). \href{https://www.theguardian.com/world/2025/dec/16/artic-record-heat-shrunken-sea-ice-report}{[Article]}\\ 
Dec. 2025 & \textit{Science Talk}, ``Arctic Warming Too Fast I Extreme Climate Risks I Sea Level Rise I Climate Projections beyond 2100?'' (\textbf{Interview}). \href{https://www.youtube.com/watch?v=6RlGo0JjUlI}{[Podcast]}\\
Oct. 2025 & \textit{VernonReporter}, ``A tool tracking billion dollar disasters is active again after being retired by Trump administration'' (\textbf{Quoted}). \href{https://vernonreporter.com/a-tool-tracking-billion-dollar-disasters-is-active-again-after-being-retired-by-trump-administration/}{[Article]}\\ 
Oct. 2025 & \textit{UCI Physical Sciences}, ``How one Earth system scientist mastered climate science communication'' (\textbf{Interview}). \href{https://ps.uci.edu/news/3388}{[Article]}\\
Oct. 2025 & \textit{Carbon Brief}, ``Antarctic sea ice winter peak in 2025 is third smallest on record'' (\textbf{Quoted}). \href{https://www.carbonbrief.org/antarctic-sea-ice-winter-peak-in-2025-is-third-smallest-on-record/}{[Article]}\\
Sep. 2025 & \textit{Quanta Magazine}, ``How Climate Scientists Saw the Future Before It Arrived'' (\textbf{Quoted}). \href{https://www.quantamagazine.org/how-climate-scientists-saw-the-future-before-it-arrived-20250915/}{[Article]}\\
Aug. 2025 & \textit{Grist}, ``Antarctica is in extreme peril'' (\textbf{Quoted}). \href{https://grist.org/climate/antarctica-is-in-extreme-peril/}{[Article]}\\
\end{tabular}
\begin{tabular}{@{}p{0.9in}p{4in}}
Aug. 2025 & \textit{CNN}, ``The strange divide in how Americans experience summer temperatures'' (\textbf{Quoted}). \href{https://www.cnn.com/2025/08/19/climate/us-summer-warming-hole-vis}{[Article]}\\
Aug. 2025 & \textit{Harvest Public Media}, ``The Midwest is getting warmer, even though summer highs are dropping. Here's why'' (\textbf{Quoted}). \href{https://www.kcur.org/news/2025-08-11/midwest-heat-high-temperatures-cooler}{[Article]}\\
Aug. 2025 & \textit{Three Degrees Podcast}, ``Climate Trends, Data, and the Fight Against Disinformation'' (\textbf{Interview}). \href{https://threedegreespodcast.substack.com/p/three-degrees-climate-trends-data}{[Podcast]}\\
Aug. 2025 & \textit{The Weather Channel}, ``Phoenix Is Facing A Heat Crisis. Here’s A Glimpse of Our Climate Future'' (\textbf{Quoted}). \href{https://weather.com/news/climate/news/2025-08-05-phoenix-heat-crisis-climate-change}{[Article]}\\
...
& Visit my \href{https://bsky.app/profile/zlabe.bsky.social}{Bluesky}! (\textit{$>$120,000 followers across social media})\\
\end{tabular}
