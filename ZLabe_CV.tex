...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.} and E.A. Barnes (2022), Comparison of climate model large ensembles with observations in the Arctic using simple neural networks. (\textit{accepted}) \href{https://www.essoar.org/doi/abs/10.1002/essoar.10510977.2}{[Preprint]}
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$47,100 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
