...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Witt, J.K., \textbf{Z.M. Labe}, A.C. Warden, and B.A. Clegg (2023). Visualizing Uncertainty in Hurricane Forecasts with Animated Risk Trajectories. (\textit{accepted to Weather, Climate, and Society})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$54,500 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
