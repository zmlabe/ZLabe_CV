...
\vspace*{-.12in}
\begin{list1}
\item[] Ph.D.~Candidate in Earth System Science (\textit{expected June 2020})
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, Y. Peings, and G. Magnusdottir (2020), Warm Arctic, cold Siberia pattern: role of full Arctic amplification versus sea ice loss alone, 2020. (\textit{Submitted})
