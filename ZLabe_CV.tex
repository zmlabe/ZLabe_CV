...
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2024). Sea surface temperature [in ``Arctic Report Card 2024'']. (\textit{submitted})
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Labe, Z.M. Timing of emergence of U.S. summer temperatures with explainable AI, Building AI-Ready workforce for heat resilience, 6th NOAA AI Workshop, USA (Sep 2024). (\textbf{Invited-Remote})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter ($>$66,900 followers)} \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
