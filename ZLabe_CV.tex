...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2022), Comparison of climate model large ensembles with observations in the Arctic using simple neural networks. Earth and Space Science, DOI:10.1029/2022EA002348. \href{https://www.essoar.org/doi/abs/10.1002/essoar.10510977.2}{[Article]}
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2022). [The Arctic] Sea surface temperature [in “State of the Climate in 2021”]. (\textit{accepted})
...
\vspace*{0.05in}\\
\begin{tabular}{@{}p{0.9in}p{4in}}
Jul. 2022 & \textit{REU Professional Development Series}, Making effective and accessible figures, Colorado State University, Fort Collins, CO. (\textbf{Presenter-Invited})\\
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$47,200 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
