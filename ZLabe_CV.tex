...
\rfoot{{\footnotesize \textcolor{MidnightBlue}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 30}}
...
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2026). [The Arctic] Sea surface temperature [in ``State of the Climate in 2025'']. (\textit{accepted})
...
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Jong, B.-T., \textbf{Z.M. Labe}, T.L. Delworth, and W.F. Cooke. Reversal of extreme precipitation trends over the Northeast US in response to aggressive climate mitigation, \textit{EGU General Assembly}, Vienna, Austria (Apr 2025). (May 2026). \href{https://doi.org/10.5194/egusphere-egu26-5420}{[Abstract]}
