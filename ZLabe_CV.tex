...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, G. Magnusdottir, and Y. Peings ($2018$), Atmospheric Response to Linking the Quasi-Biennial Oscillation and Projected Arctic Sea-Ice Loss in Early Winter. (\textit{drafting paper})
\end{etaremune}
