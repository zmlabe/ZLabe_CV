...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2021). Sea surface temperature [in ``Arctic Report Card 2021''], NOAA. (\textit{in review})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$39,700 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
