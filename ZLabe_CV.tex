...
\rfoot{{\footnotesize \textcolor{Cerulean}{\textbf{Zachary Labe}} \\ Curriculum Vit\ae, Page \textbf{[\thepage]} of 12}}
...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item Timmermans, M.-L. and \textbf{Z.M. Labe} (2021), [The Arctic] Sea surface temperature [in ``State of the Climate in 2020'']. Bull. Amer. Meteor. Soc. (\textit{in prep})
...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2021), Detecting climate signals using explainable AI with single-forcing large ensembles. Journal of Advances in Modeling Earth Systems (\textit{submitted}) \href{https://www.essoar.org/doi/10.1002/essoar.10505762.1}{[Preprint]}
\item Peings, Y., \textbf{Z.M. Labe}, and G. Magnusdottir (2021), Are 100 ensemble members enough to capture the remote atmospheric response to $+$2$^{\circ}$C Arctic sea ice loss? Journal of Climate (\textit{revised})
\end{etaremune}
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$33,000 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
