...
\item Witt, J.K., \textbf{Z.M. Labe}, A.C. Warden, and B.A. Clegg (2021). Visualizing Uncertainty in Hurricane Forecasts with Dynamic Ensembles. Wea., Climate, and Soc. (\textit{submitted})
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$36,600 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
