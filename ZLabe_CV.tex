...
\item \textbf{Labe, Z.M.} and E.A. Barnes (2021), Detecting climate signals using explainable AI with single-forcing large ensembles. Journal of Advances in Modeling Earth Systems (\textit{accepted}) \href{https://www.essoar.org/doi/10.1002/essoar.10505762.2}{[Preprint]}
...
& Visit my \href{https://twitter.com/ZLabe}{Twitter} ($>$35,600 followers) \includegraphics[height=9pt]{twitter.png}\ !\\
\end{tabular}
