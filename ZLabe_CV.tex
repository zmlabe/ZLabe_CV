...
\vspace*{-0.1in}\\
\begin{etaremune}[leftmargin=0in,topsep=0in,parsep=0in]
\item \textbf{Labe, Z.M.}, Y. Peings, and G. Magnusdottir ($2018$). Contributions of ice thickness to the atmospheric response from projected Arctic sea ice loss. (\textit{submitted})
